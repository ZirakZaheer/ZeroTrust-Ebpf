 ...
 #          print("Launching host %i of %i" % (i + 1, num_hosts))
  #         ipaddr = "172.16.1.%d/24" % (100 + i)
   #        host_info.append(self._create_ns("host%d" % i, ipaddr=ipaddr,
    #         disable_ipv6=True))
	host_info.append(self._create_ns("a2682971f71c", ipaddr="174.17.0.5/16")) #vport_test5
        host_info.append(self._create_ns("6f02a6b4129e",ipaddr="174.17.0.3/16")) #vport_test4
#	print host_info
